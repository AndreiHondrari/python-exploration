...
ETH_MAX_MTU =           0xFFFF  # 65535, same as IP_MAX_MTU
...
ETH_P_802_3_MIN =       0x0600  # If the value in the ethernet type is more than this value
...
ETH_P_MAP =             0x00F9  # Qualcomm multiplexing and
                                # aggregation protocol

ETH_P_MCTP =            0x00FA  # Management component transport
                                # protocol packets
