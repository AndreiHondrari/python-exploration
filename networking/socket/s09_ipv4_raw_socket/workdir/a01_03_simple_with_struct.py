...
Usage of struct for encoding the IP packet header.

Important: the IP_HDRINCL is enabled to make sure checksum and total length
are computed by the socket code at send.
"""
import random
import socket
import functools
