...
def main() -> None:
    ...
    # total_length = calculate_total_length(ip_packet) - 10
    # hprint("actual total length", total_length)
    # header_bytes.total_length = total_length.to_bytes(2, 'big')
    #
    # header_bytes.header_checksum = (0).to_bytes(2, 'big')
    header_bytes.total_length = b'\x00\x00'
    header_bytes.header_checksum = b'\x00\x00'
